...
get_metadata <- function(){
  ...
  tibble::tribble(
    ...
    "Privat_konsum",
    "Konsum i husholdninger, faste 2023-priser",
    "SSB",
    "https://data.ssb.no/api/v0/no/table/nk/nk03/knr/SBMENU5140/NRMakroHov",
    "09189",
    "Millioner kroner, faste 2023-priser",
    ...
    NA,
    "get_konsum",
    "Makrost = koh.nr61_, ContentsCode = Faste",
    
    "Offentlig_konsum",
    "Konsum i offentlig forvaltning, faste 2023-priser",
    "SSB",
    "https://data.ssb.no/api/v0/no/table/nk/nk03/knr/SBMENU5140/NRMakroHov",
    "09189",
    "Millioner kroner, faste 2023-priser",
    ...
    NA,
    "get_konsum",
    "Makrost = koo.nroff, ContentsCode = Faste",
    
    "Privat_konsum_vekst",
    "Årlig prosentvis vekst i privat konsum",
    "Beregnet",
    NA,
    "Privat_konsum",
    "Prosent",
    ...
    NA,
    "get_konsum",
    "Beregnet som (Privat_konsum / lag(Privat_konsum) - 1) * 100",
    
    "Offentlig_konsum_vekst",
    "Årlig prosentvis vekst i offentlig konsum",
    "Beregnet",
    NA,
    "Offentlig_konsum",
    "Prosent",
    ...
    NA,
    "get_konsum",
    "Beregnet som (Offentlig_konsum / lag(Offentlig_konsum) - 1) * 100",
    
    "Privat_konsum_andel_BNP",
    "Privat konsum som andel av BNP Fastlands-Norge",
    "Beregnet",
    NA,
    "Privat_konsum og BNP_Fastland",
    "Prosent",
    "Årlig",
    1970,
    NA,
    "create_derived_variables",
    "Beregnet som Privat_konsum / BNP_Fastland * 100",
    
    "Offentlig_konsum_andel_BNP",
    "Offentlig konsum som andel av BNP Fastlands-Norge",
    "Beregnet",
    NA,
    "Offentlig_konsum og BNP_Fastland",
    "Prosent",
    "Årlig",
    1970,
    NA,
    "create_derived_variables",
    "Beregnet som Offentlig_konsum / BNP_Fastland * 100",
    
    "Disponibel_inntekt_husholdninger",
    "Husholdningenes disponible inntekt",
    "SSB",
    "https://data.ssb.no/api/v0/no/table/nk/nk03/knri/NRI",
    "10799",
    "Millioner kroner, løpende priser",
    "Årlig",
    1978,
    NA,
    "get_disponibel_inntekt",
    "Sektor = Husholdninger, Transaksjon = Disponibel inntekt",
    ...
    NA,
    "get_sparing",
    "Sektor = Husholdninger, Transaksjon = Sparing",
    
    "Husholdningssparing_vekst",
    "Årlig prosentvis vekst i husholdningenes sparing",
    "Beregnet",
    NA,
    "Husholdningssparing",
    "Prosent",
    ...
    NA,
    "get_sparing",
    "Beregnet som (Husholdningssparing / lag(Husholdningssparing) - 1) * 100",
    
    "Husholdningssparing_andel_disponibel_inntekt",
    "Husholdningenes sparing som andel av disponibel inntekt",
    "Beregnet",
    NA,
    "Husholdningssparing og Disponibel_inntekt_husholdninger",
    "Prosent",
    "Årlig",
    1978,
    NA,
    "create_derived_variables",
    "Beregnet som Husholdningssparing / Disponibel_inntekt_husholdninger * 100",
    
    "Handelsbalanse",
    "Eksport minus import, faste 2023-priser",
    "Beregnet",
    NA,
    "Eksport og Import",
    "Millioner kroner, faste 2023-priser",
    ...
    NA,
    "create_derived_variables",
    "Beregnet som Eksport - Import",
    
    "Handelsbalanse_andel_BNP",
    "Handelsbalanse som andel av BNP Fastlands-Norge",
    "Beregnet",
    NA,
    "Handelsbalanse og BNP_Fastland",
    "Prosent",
    "Årlig",
    1970,
    NA,
    "create_derived_variables",
    "Beregnet som Handelsbalanse / BNP_Fastland * 100",
    
    "Eksportandel_BNP",
    "Eksport som andel av BNP Fastlands-Norge",
    "Beregnet",
    NA,
    "Eksport og BNP_Fastland",
    "Prosent",
    "Årlig",
    1970,
    NA,
    "create_derived_variables",
    "Beregnet som Eksport / BNP_Fastland * 100",
    
    "Importandel_BNP",
    "Import som andel av BNP Fastlands-Norge",
    "Beregnet",
    NA,
    "Import og BNP_Fastland",
    "Prosent",
    "Årlig",
    1970,
    NA,
    "create_derived_variables",
    "Beregnet som Import / BNP_Fastland * 100",
  )
}